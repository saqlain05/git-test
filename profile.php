							...
							<div class="col-xs-12">
								<form id="login-form" method="post">
									...
									<div class="contact-btn">
										<button type="button" class="fv-btn" onclick="update_profile()" id="btn_submit">Update Your Name</button>
									...
									<div class="single-contact-form">
										<label class="password_label">User Name/Email ID</label>
										<div class="contact-box name">
											<input disabled type="text" name="current_password"  value="<?php echo $_SESSION['email']?>"
											id="current_password" style="width:100%; cursor: no-drop;">
										</div>
									...
									<div class="single-contact-form">
										...
										<div class="contact-box name">
											<input disabled type="text" name="current_password"  value="<?php echo $_SESSION['mobile']?>"
											id="current_password" style="width:100%; cursor: no-drop;">
										</div>
										<span class="field_error" id="current_password_error"></span>
									</div>
