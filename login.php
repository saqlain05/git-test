								...
								<form id="register-form" method="post">
									...
									<div class="single-contact-form">
										<div class="contact-box name">
											...
											<input type="text" id="email_otp" placeholder="OTP*" style="width:66%" class="email_verify_otp">
...
<!-- <script>
	function email_sent_otp(){
		...
		if(email==''){
			jQuery('#email_error').html('Please Enter Correct Email_id');
		}else{
			jQuery.ajax({
				url: 'send_otp.php',
				type: 'post',
			...
			jQuery('.email_sent_otp').hide();
						...
						jQuery('#email_error').html('plese try after sometime');
					}
				}
			})
	...
	function email_verify_otp(){
		...
		if(email_otp==''){
			jQuery('#email_error').html('Please Enter Correct OTP');
		}else{
